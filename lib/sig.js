...
const extractDecipher = body => {
  ...
  const decipherFunc = extractDecipherWithName(body) || extractDecipherFunc(body);
...
const extractNTransform = body => {
  ...
  const nTransformFunc = extractNTransformFunc(body) || extractNTransformWithName(body);
